...
function openShutdownDialog(){var name=$(this).closest("li").find("div:first").html().trim();$("div.shutdown h2 span").html(name);$("div.shutdown input[name='ip']").val($(this).data("ip"));$.fancybox({content:$("div.shutdown").show(),});}
