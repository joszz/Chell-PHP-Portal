...
﻿var checkDeviceStatesTimeout=30,alertTimeout=5;var checkDeviceStatesIntervalId,alertIntervalId;var altPressed=false;var fancyboxMargin=[70,0,60,0];$(function(){initializeEventHandlers();checkDeviceStates();checkDeviceStatesIntervalId=setInterval(checkDeviceStates,checkDeviceStatesTimeout*1000);});function initializeEventHandlers(){$("div.devices").on("click","a.btn-danger",wol);$("div.devices").on("click","a.btn-success",openShutdownDialog);$("div.shutdown input[type='submit']").click(doShutdown);$("div.devices div.panel-heading a.glyphicon-refresh").click(function(){clearInterval(checkDeviceStatesIntervalId);checkDeviceStates();checkDeviceStatesIntervalId=setInterval(checkDeviceStates,checkDeviceStatesTimeout*1000);return false;});$("a.fancybox.iframe").fancybox({type:"iframe",margin:fancyboxMargin});$(".shorten").shorten();$("a, button").vibrate();$("body").keydown(function(e){if(altPressed){if(e.which==77&&altPressed){altPressed=false;$(".navbar-toggle").trigger("click");}
...
function openShutdownDialog(){var name=$(this).closest("li").find("div:first").html().trim();$("div.shutdown h2 span").html(name);$("div.shutdown input[name='ip']").val($(this).data("ip"));$.fancybox({content:$("div.shutdown").show(),margin:fancyboxMargin});}
